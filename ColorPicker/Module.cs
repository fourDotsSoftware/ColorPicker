...
namespace ColorPicker
{
    class Module
    {
        ...
        public static string ApplicationName = "Color Picker 4dots";
        ...
        public static string DownloadURL = "https://www.4dots-software.com/d/ColorPicker/";
        public static string HelpURL = "https://www.4dots-software.com/color-picker/how-to-use.php";
        public static string ProductWebpageURL = "https://www.4dots-software.com/color-picker/";
        public static string BuyURL = "https://www.4dots-software.com/store/buy-color-picker.php";
        public static string VersionURL = "http://cssspritestool.com/versions/color-picker.txt";
        ...
        "Document Files (*.docx;*.txt;*.doc;*.rtf;)|*.docx;*.txt;*.doc;*.rtf;|All Files (*.*)|*.*";
        ...
        public static string TempFolder
        {
            get
            {
                string path = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "ColorPicker");
