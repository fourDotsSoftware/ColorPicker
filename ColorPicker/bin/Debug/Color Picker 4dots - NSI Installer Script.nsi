...
; Start
  ...
  !define MUI_FILE "ColorPicker"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Color Picker 4dots"
  !define PRODUCT_SHORTCUT "Color Picker 4dots"
  !define PRODUCT_VERSION "2.0"
  
  !define MUI_ICON "palette2.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  BrandingText "https://www.4dots-software.com"
  ...
  Name "Color Picker 4dots"
  OutFile "ColorPickerSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Color Picker 4dots" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Color Picker 4dots - User's Manual.url.lnk" "$INSTDIR\Color Picker 4dots - User's Manual.url" "" "$INSTDIR\Color Picker 4dots - User's Manual.url" 0
...
;  ExecWait "$PLUGINSDIR\Installmanager.exe 015" 
 ...
 ; File "readme.txt"
  ;File "..\..\..\helpfile\Color Picker 4dots - User's Manual.chm";
  File "Color Picker 4dots - User's Manual.url";
  ;File "ddb.dat"
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Color Picker 4dots" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Color Picker 4dots" "InstallationDirectory" $INSTDIR
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Color Picker 4dots"
  DeleteRegKey HKCU "Software\4dots Software\Color Picker 4dots"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/color-picker/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/color-picker/how-to-use.php?afterinstall=true"
FunctionEnd
